...
#  hae_km: HAE given in kilometers
#
# Output:
#  The ECEF coordinates (r_x, r_y, r_z) in kilometers
#
...
lat_rad = lat_deg * math.pi / 180.0 #converts latitude degrees to radians
lon_rad = lon_deg * math.pi / 180.0 #converts longitude degrees to radians
